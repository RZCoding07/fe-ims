...
function toggleDropdown(e: React.MouseEvent<HTMLButtonElement, MouseEvent>) {
  ...
  // Tampilkan loading state jika masih memuat data user
  if (isLoading) {
    return (
      <div className="flex items-center text-gray-700 dark:text-gray-400">
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11 bg-gray-200 dark:bg-gray-700 animate-pulse"></span>
        <span className="mr-1 font-medium text-theme-sm bg-gray-200 dark:bg-gray-700 h-4 w-20 animate-pulse rounded"></span>
        ...
        <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800">
          ...
          <li>
            <DropdownItem
              onItemClick={closeDropdown}
              tag="a"
              href="/settings" // Ubah dari /profile ke /settings untuk account settings
              className="flex items-center gap-3 px-3 py-2 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
            >
              <svg
                className="fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-300"
